            ...
            <div class="Dashboard Dashboard--full" id="analytics-dashboard">
                <header class="Dashboard-header">
                    <ul class="FlexGrid">
                        <li class="FlexGrid-item">
                            <div class="Titles">
                                <h1 class="Titles-main" id="view-name">{{ __('admin.analytics.select_view') }}</h1>
                                <div class="Titles-sub">{{ __('admin.analytics.various_visualizations') }}</div>
                            </div>
                        </li>
                ...
                <ul class="FlexGrid FlexGrid--halves">
                    <li class="FlexGrid-item">
                        <div class="Chartjs">
                            <header class="Titles">
                                <h1 class="Titles-main">{{ __('admin.analytics.this_vs_last_week') }}</h1>
                                <div class="Titles-sub">{{ __('admin.analytics.by_users') }}</div>
                            </header>
                    ...
                    <li class="FlexGrid-item">
                        <div class="Chartjs">
                            <header class="Titles">
                                <h1 class="Titles-main">{{ __('admin.analytics.this_vs_last_year') }}</h1>
                                <div class="Titles-sub">{{ __('admin.analytics.by_users') }}</div>
                            </header>
                    ...
                    <li class="FlexGrid-item">
                        <div class="Chartjs">
                            <header class="Titles">
                                <h1 class="Titles-main">{{ __('admin.analytics.top_browsers') }}</h1>
                                <div class="Titles-sub">{{ __('admin.analytics.by_pageview') }}</div>
                            </header>
                    ...
                    <li class="FlexGrid-item">
                        <div class="Chartjs">
                            <header class="Titles">
                                <h1 class="Titles-main">{{ __('admin.analytics.top_countries') }}</h1>
                                <div class="Titles-sub">{{ __('admin.analytics.by_sessions') }}</div>
                            </header>
                ...
                function renderYearOverYearChart(ids) {
                    ...
                    Promise.all([thisYear, lastYear]).then(function (results) {
                        ...
                        var data = {
                            ...
                            datasets: [
                                {
                                    label: '{{ __('admin.date.last_year') }}',
                                    fillColor: 'rgba(220,220,220,0.5)',
                                    strokeColor: 'rgba(220,220,220,1)',
                                    data: data2
                                },
                                {
                                    label: '{{ __('admin.date.this_year') }}',
                                    fillColor: 'rgba(151,187,205,0.5)',
                                    strokeColor: 'rgba(151,187,205,1)',
                                    data: data1
                                }
