...
@endif
<script>
    function changeCategory(element, removeFilter) {
        var el = $(element);
        var id = el.val();
        $.ajax({
            type: 'get',
            url: '/get-function-and-produce',
            data: {category_id:id},
            success:function(result) {
                ...
                $('.select2-selection--multiple').find('.select2-selection__rendered').empty();
    ...
    var categoryId = $('select[name="category_id"]');
//    changeCategory(categoryId, 1);
</script>
</body>
</html>
